...
<body>
	<div id=<%=xxxx%> class="content" 
		...
		<ria:spliterlayout style="width: <%=width%>; overflow-x: hidden; overflow-y: hidden; height: <%=height%>; ">
			Multi-level split layout
			<ria:slcolumn width="43%">
				<ria:slCell height="20%" style="background-color:#FFD24D">Top left cell</ria:slCell>
				<ria:slCell height="20%" style="background-color:#C6B3FF">Middle left cell</ria:slCell>
				<ria:slCell height="60%">Bottom left cell </ria:slCell>
			</ria:slcolumn>
			<ria:slcolumn style="background-color:#CCDAFF" width="29%">Middle column</ria:slcolumn>
			<ria:slcolumn style="background-color:#88AAFF" width="28%">Right column</ria:slcolumn>
		</ria:spliterlayout>
	</div>
</body>
</html>