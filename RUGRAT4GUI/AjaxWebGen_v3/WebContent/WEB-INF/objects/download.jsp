...
<body>
	<div id=<%=xxxx%> class="content" style="width:<%=width%>;height:<%=height%>;margin:<%=margin%>;border:<%=border%>;padding:<%=padding%>;">
		<script type="text/javascript">
			var activeContext = SweetDevRia.ContextManager.getInstance()
					.getActiveContext();
			function download() {
				SweetDevRia_downloadResource(
						'http://www.ideotechnologies.com/images/logo.jpg',
						'logo.jpg', 'image/jpg', activeContext);
			}
		</script>
		<a href="#" onclick="download();">Click here to download an image</a>
	</div>
</body>
</html>