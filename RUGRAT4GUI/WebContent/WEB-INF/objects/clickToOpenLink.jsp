...
<body>
	<div id=<%=xxxx%> class="content" style="width:<%=width%>;height:<%=height%>;margin:<%=margin%>;border:<%=border%>;padding:<%=padding%>;">
	 	<ria:clickToOpenLink contentId="helloId" titleLink="Click to show">Click me</ria:clickToOpenLink>
		<ria:clickToOpenContent id="helloId"> Hello World ! <br /> This content can be shown/hidden on demand !</ria:clickToOpenContent>
	</div>
</body>
</html>