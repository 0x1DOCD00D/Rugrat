	...
	extends Operand
{
	...
	{	
		...
		{
			int randomIndex = new Random().nextInt(classList.size()); // gets a random number
			classname = classList.get(randomIndex).getFileName(); // gets a random class from the class name list
		}
